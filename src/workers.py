...
#    🔴 它**只读**：2026-09-18 已定「组策略不做编辑，只做看得见」，
...
# ============================================================================
#
# ⚠️ 已定：「把操作共享盘这个功能，**全部删除掉**，不要这个功能了，直接
#    远程登录文件服务器来加权限。」⇒ 本模块原先这一整块（取身份 / 打开编辑器 /
...
#    下一个读代码的人知道"这里曾经有东西、它是有意识地拿掉的"，而不是
#    以为漏写。
#
...
#    销掉。被删掉的那份实现与它的实测结论都在库外留档里，**代码不保留**。
